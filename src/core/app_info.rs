...
use crate::{core::queue::QueueType, PhysicalDevice, Window};
...
pub struct GPURequirements {
    ...
    /// Custom callback function for filtering off GPUs
    #[derivative(Debug = "ignore")]
    #[derivative(Default(value="Box::new(|_| -> usize { 0 })"))]
    pub selection: Box<dyn Fn(&[PhysicalDevice]) -> usize>,
}
